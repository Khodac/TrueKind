...
@section('content')    
        ...
        <main>
            <article>
                ...
                <!-- HERO -->
                <section class="section hero has-bg-image" id="home" aria-label="home" style="background-image: url('{{ asset('img/hero-banner.jpg') }}')">
                  ...
                  <div class="container">
                    ...
                    <ul class="has-scrollbar">
                      <li class="scrollbar-item wow animate__animated animate__fadeInLeft"> 
                        <div class="category-card">
                          <figure class="card-banner img-holder" style="--width: 330; --height: 300">
                            <img src="{{ asset('img/toys.jpg')}}" width="330" height="300" loading="lazy" alt="toys" class="img-cover" />
                          </figure>
                          <h3 class="h3">
                      ...
                      <li class="scrollbar-item wow animate__animated animate__fadeInLeft"> 
                        <div class="category-card">
                          <figure class="card-banner img-holder" style="--width: 330; --height: 300">
                            <img src="{{ asset('img/clothes.jpg')}}" width="330" height="300" loading="lazy" alt="clothes" class="img-cover" />
                          </figure>
                          <h3 class="h3">
                      ...
                      <li class="scrollbar-item wow animate__animated animate__fadeInLeft"> 
                        <div class="category-card">
                          <figure class="card-banner img-holder" style="--width: 330; --height: 300">
                            <img src="{{ asset('img/furniture.jpg')}}" width="330" height="300" loading="lazy" alt="furniture" class="img-cover" />
                          </figure>
                          <h3 class="h3">
                      ...
                      <li class="scrollbar-item wow animate__animated animate__fadeInLeft"> 
                        <div class="category-card">
                          <figure class="card-banner img-holder" style="--width: 330; --height: 300">
                            <img src="{{ asset('img/sneakers.jpg')}}" width="330" height="300" loading="lazy" alt="sneakers" class="img-cover" />
                          </figure>
                          <h3 class="h3">
                      ...
                      <li class="scrollbar-item wow animate__animated animate__fadeInLeft"> 
                        <div class="category-card">
                          <figure class="card-banner img-holder" style="--width: 330; --height: 300">
                            <img src="{{ asset('img/books.jpg')}}"width="330" height="300" loading="lazy" alt="books" class="img-cover" />
                          </figure>
                          <h3 class="h3">
                  ...
                  <div class="container">
                    ...
                    <ul class="grid-list">
                      <li class="scrollbar-item wow animate__animated animate__fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="service-card">
                          <figure class="card-icon">
                            <img  src="{{ asset('img/service-icon-1.png')}}" width="70" height="70" loading="lazy" alt="service icon" />
                          </figure>
                      ...
                      <li class="scrollbar-item wow animate__animated animate__fadeInLeft" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="service-card">
                          <figure class="card-icon">
                            <img src="{{ asset('img/service-icon-2.png')}}" width="70" height="70" loading="lazy" alt="service icon" />
                          </figure>
                      ...
                      <li class="scrollbar-item wow animate__animated animate__fadeInLeft" data-wow-duration="1s" data-wow-delay="0.6s">
                        <div class="service-card">
                          <figure class="card-icon">
                            <img src="{{ asset('img/service-icon-3.png')}}" width="70" height="70" loading="lazy" alt="service icon" />
                          </figure>
                      ...
                      <li class="scrollbar-item wow animate__animated animate__fadeInLeft" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="service-card">
                          <figure class="card-icon">
                            <img src="{{ asset('img/service-icon-4.png')}}" width="70" height="70" loading="lazy" alt="service icon" />
                          </figure>
                ...
                <!-- CTA -->
                <section class="cta has-bg-image" aria-label="cta" style="background-image: url('{{ asset('img/cta-bg.jpg') }}')">
                  <div class="container">
                    <figure class="cta-banner">
                      <img src="{{ asset('img/envíoGirlRedimension.png')}}" width="900" height="660" loading="lazy" alt="shippinggirl" class="w-100 wow animate__animated animate__fadeInLeft" />
                    </figure>
                
                    <div class="cta-content">
                      <div class="containerGuarantee">
                        <img  src="{{ asset('img/iconoGarantia.png')}}" width="120" height="35" loading="lazy" alt="taste guarantee" class="img" id="iconoGarantia" />
                        <h2>GUARANTEE</h2>
                      </div>
